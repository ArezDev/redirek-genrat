      ...
      <div className="w-full max-w-xl bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 flex flex-wrap md:flex-nowrap items-center gap-4 mt-4">
        ...
        { shortURL === "1" && (
          <div className="flex flex-col min-w-[160px]">
            ...
            <input
              type="text"
              placeholder="https://cdn.fbsbx.com/v/t59.2708-21/538567453_1790783414853868_8166523081647910159_n.ico/9140184775756580494.ico?_nc_cat=102&ccb=1-7&_nc_sid=2b0e22&_nc_ohc=D0g6YCofFOAQ7kNvwH3MXuZ&_nc_oc=AdmRl9pDpSvnjO9kE2eslfrow8nfR6l3gQZBTTGql9emB3TSGTFoP2ArYWgiMIxkCqU&_nc_zt=7&_nc_ht=cdn.fbsbx.com&_nc_gid=MMZKSjlwe7aQgEteoqFLXg&oh=03_Q7cD3AHAziDOvFDSB9OgilTP9NK7k2SxhUhN0kZSRW6rx2GYsQ&oe=68AE7990&dl=1&fbclid=IwZXh0bgNhZW0CMTEAYnJpZBExalpEaGRYUWRmSElOT01naAEeAUfBcn5u_5WP51vimgBv5xKQuvQSH2vFW3VhY7R9NX6Dl4q4hLEtsNWOoGQ_aem_bXeVBEeRbD6ct4M3Lvq05A"
              value={imgPostplay}
